...
@XmlRootElement(name = "Manifest", namespace = "http://www.geonovum.nl/stri/2012/2.0")
public class Manifest {

    @XmlElement(name = "Dossier", namespace = "http://www.geonovum.nl/stri/2012/2.0", required = true)
