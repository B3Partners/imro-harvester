 ...
 *         &lt;element name="verwijzingNaarTekstInfo" type="{http://www.geonovum.nl/imro/2008/1}TekstReferentie_XGBPropertyType" maxOccurs="unbounded"/>
 ...
 *         &lt;element name="besluitgebied" type="{http://www.geonovum.nl/imro/2008/1}Besluitgebied_XPropertyType"/>
 *         &lt;element name="besluitvlak" type="{http://www.geonovum.nl/imro/2008/1}Besluitvlak_XPropertyType" maxOccurs="unbounded" minOccurs="0"/>
 *         &lt;element name="besluitsubvlak" type="{http://www.geonovum.nl/imro/2008/1}Besluitsubvlak_XPropertyType" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/extension>
 *   &lt;/complexContent>
 * &lt;/complexType>
    ...
    extends PlanobjectType
{
    ...
    @XmlElement(required = true)
    protected BesluitgebiedXPropertyType besluitgebied;
    protected List<BesluitvlakXPropertyType> besluitvlak;
    protected List<BesluitsubvlakXPropertyType> besluitsubvlak;
     ...
     * @return
     *     possible object is
     *     {@link BesluitgebiedXPropertyType }
     *     
     */
    public BesluitgebiedXPropertyType getBesluitgebied() {
     ...
     *     
     */
    public void setBesluitgebied(BesluitgebiedXPropertyType value) {
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link BesluitvlakXPropertyType }
     * 
     * 
     */
    public List<BesluitvlakXPropertyType> getBesluitvlak() {
        if (besluitvlak == null) {
            besluitvlak = new ArrayList<BesluitvlakXPropertyType>();
        }
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link BesluitsubvlakXPropertyType }
     * 
     * 
     */
    public List<BesluitsubvlakXPropertyType> getBesluitsubvlak() {
        if (besluitsubvlak == null) {
            besluitsubvlak = new ArrayList<BesluitsubvlakXPropertyType>();
        }
