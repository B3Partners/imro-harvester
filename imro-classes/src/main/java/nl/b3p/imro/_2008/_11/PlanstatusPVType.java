...
/**
 * <p>Java class for Planstatus_PVType.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * <p>
 * <pre>
 * &lt;simpleType name="Planstatus_PVType">
 ...
 * 
 */
@XmlType(name = "Planstatus_PVType")
@XmlEnum
public enum PlanstatusPVType {
    ...
    public static PlanstatusPVType fromValue(String v) {
        for (PlanstatusPVType c: PlanstatusPVType.values()) {
            if (c.value.equals(v)) {
                return c;
            }
        }
