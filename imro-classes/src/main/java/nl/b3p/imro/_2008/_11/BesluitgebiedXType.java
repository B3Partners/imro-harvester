...
/**
 * <p>Java class for Besluitgebied_XType complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="Besluitgebied_XType">
 *   &lt;complexContent>
 *     &lt;extension base="{http://www.geonovum.nl/imro/2008/1}PlangebiedType">
 *       &lt;sequence>
 *         &lt;element name="typePlan" type="{http://www.geonovum.nl/imro/2008/1}RuimtelijkPlanOfBesluit_XGBType"/>
 *         &lt;element name="beleidsmatigVerantwoordelijkeOverheid" type="{http://www.geonovum.nl/imro/2008/1}Overheden_XGBType"/>
 ...
 *         &lt;element name="normadressant" type="{http://www.geonovum.nl/imro/2008/1}Normadressant_XGBType" maxOccurs="unbounded" minOccurs="0"/>
 *         &lt;element name="locatieNaam" type="{http://www.geonovum.nl/imro/2008/1}NotEmptyString" maxOccurs="unbounded" minOccurs="0"/>
 *         &lt;element name="planstatusInfo" type="{http://www.geonovum.nl/imro/2008/1}PlanstatusEnDatum_XGBPropertyType"/>
 ...
 *         &lt;element name="verwijzingNaarTekstInfo" type="{http://www.geonovum.nl/imro/2008/1}TekstReferentieBG_XGBPropertyType" maxOccurs="6"/>
 ...
 *         &lt;element name="verwijzingNaarIllustratieInfo" type="{http://www.geonovum.nl/imro/2008/1}IllustratieReferentie_XGBPropertyType" maxOccurs="unbounded" minOccurs="0"/>
 *         &lt;element name="verwijzingNaarExternPlanInfo" type="{http://www.geonovum.nl/imro/2008/1}ExternPlanReferentie_XGBPropertyType" maxOccurs="unbounded" minOccurs="0"/>
...
@XmlType(name = "Besluitgebied_XType", propOrder = {
    "typePlan",
...
public class BesluitgebiedXType
    extends PlangebiedType
{

    @XmlElement(required = true)
    protected RuimtelijkPlanOfBesluitXGBType typePlan;
    @XmlElement(required = true)
    protected OverhedenXGBType beleidsmatigVerantwoordelijkeOverheid;
    @XmlElement(required = true)
    ...
    @XmlElement(required = true)
    protected PlanstatusEnDatumXGBPropertyType planstatusInfo;
    protected String besluitnummer;
    protected String verwijzingNaarVaststellingsbesluit;
    @XmlElement(required = true)
    protected List<TekstReferentieBGXGBPropertyType> verwijzingNaarTekstInfo;
    protected List<String> verwijzingNaarObjectgerichteTekst;
    @XmlElement(required = true)
    protected List<String> ondergrond;
    protected List<IllustratieReferentieXGBPropertyType> verwijzingNaarIllustratieInfo;
    protected List<ExternPlanReferentieXGBPropertyType> verwijzingNaarExternPlanInfo;
    @XmlElement(required = true)
     ...
     * @return
     *     possible object is
     *     {@link RuimtelijkPlanOfBesluitXGBType }
     *     
     */
    public RuimtelijkPlanOfBesluitXGBType getTypePlan() {
        return typePlan;
    }
     ...
     *     
     */
    public void setTypePlan(RuimtelijkPlanOfBesluitXGBType value) {
        this.typePlan = value;
    }
     ...
     * @return
     *     possible object is
     *     {@link OverhedenXGBType }
     *     
     */
    public OverhedenXGBType getBeleidsmatigVerantwoordelijkeOverheid() {
     ...
     *     
     */
    public void setBeleidsmatigVerantwoordelijkeOverheid(OverhedenXGBType value) {
     ...
     * @return
     *     possible object is
     *     {@link PlanstatusEnDatumXGBPropertyType }
     *     
     */
    public PlanstatusEnDatumXGBPropertyType getPlanstatusInfo() {
     ...
     *     
     */
    public void setPlanstatusInfo(PlanstatusEnDatumXGBPropertyType value) {
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link TekstReferentieBGXGBPropertyType }
     * 
     * 
     */
    public List<TekstReferentieBGXGBPropertyType> getVerwijzingNaarTekstInfo() {
        if (verwijzingNaarTekstInfo == null) {
            verwijzingNaarTekstInfo = new ArrayList<TekstReferentieBGXGBPropertyType>();
        }
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link IllustratieReferentieXGBPropertyType }
     * 
     * 
     */
    public List<IllustratieReferentieXGBPropertyType> getVerwijzingNaarIllustratieInfo() {
        if (verwijzingNaarIllustratieInfo == null) {
            verwijzingNaarIllustratieInfo = new ArrayList<IllustratieReferentieXGBPropertyType>();
        }
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link ExternPlanReferentieXGBPropertyType }
     * 
     * 
     */
    public List<ExternPlanReferentieXGBPropertyType> getVerwijzingNaarExternPlanInfo() {
        if (verwijzingNaarExternPlanInfo == null) {
            verwijzingNaarExternPlanInfo = new ArrayList<ExternPlanReferentieXGBPropertyType>();
        }
