...
@XmlType(name = "CurveArrayPropertyType", namespace = "http://www.opengis.net/gml", propOrder = {
    "curve"
})
public class CurveArrayPropertyType {

    @XmlElement(name = "_Curve")
    protected List<AbstractCurveType> curve;
     ...
     * 
     */
    public List<AbstractCurveType> getCurve() {
        if (curve == null) {
            curve = new ArrayList<AbstractCurveType>();
        }
        return this.curve;
    }
