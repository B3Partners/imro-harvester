...
/**
 * <p>Java class for ProvinciaalPlangebiedType complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="ProvinciaalPlangebiedType">
 *   &lt;complexContent>
 ...
 *         &lt;element name="planstatusInfo" type="{http://www.ravi.nl/imro2006}PlanstatusPPenDatumPropertyType"/>
 *         &lt;element name="provincieCode" type="{http://www.w3.org/2001/XMLSchema}string" maxOccurs="unbounded"/>
...
@XmlType(name = "ProvinciaalPlangebiedType", propOrder = {
    "geometrie",
    "locatieNaam",
    "naam",
    "planstatusInfo",
...
public class ProvinciaalPlangebiedType
    extends PlangebiedType
{
    ...
    @XmlElement(required = true)
    protected PlanstatusPPenDatumPropertyType planstatusInfo;
    @XmlElement(required = true)
    protected List<String> provincieCode;
    @XmlElement(required = true)
     ...
     * @return
     *     possible object is
     *     {@link PlanstatusPPenDatumPropertyType }
     *     
     */
    public PlanstatusPPenDatumPropertyType getPlanstatusInfo() {
     ...
     *     
     */
    public void setPlanstatusInfo(PlanstatusPPenDatumPropertyType value) {
     ...
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the provincieCode property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getProvincieCode().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<String> getProvincieCode() {
        if (provincieCode == null) {
            provincieCode = new ArrayList<String>();
        }
