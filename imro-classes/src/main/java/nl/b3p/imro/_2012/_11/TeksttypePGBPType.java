...
/**
 * <p>Java class for TeksttypePG_BPType.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * <p>
 * <pre>
 * &lt;simpleType name="TeksttypePG_BPType">
 ...
 * 
 */
@XmlType(name = "TeksttypePG_BPType")
@XmlEnum
public enum TeksttypePGBPType {
    ...
    public static TeksttypePGBPType fromValue(String v) {
        for (TeksttypePGBPType c: TeksttypePGBPType.values()) {
            if (c.value.equals(v)) {
                return c;
            }
        }
